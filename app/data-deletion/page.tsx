...
export const metadata = {
  title: 'Data Deletion | Voxility',
  description: 'How to request deletion of your Voxility account data, including data obtained through connected platforms like Facebook and Instagram.',
}
      ...
      <section className="relative py-20 px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            You can request deletion of any data Voxility holds about you at any time. Here&apos;s how.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          <div className="vox-card p-6 rounded-xl">
            ...
            <p className="text-sm leading-relaxed mb-4" style={{ color: 'var(--text-secondary)' }}>
              Email <a href="mailto:support@voxility.io?subject=Data%20Deletion%20Request" className="text-gradient font-medium">support@voxility.io</a> from
              the address associated with your Voxility account, with the subject line <strong>&ldquo;Data Deletion Request&rdquo;</strong>.
            </p>
          ...
          <div className="vox-card p-6 rounded-xl">
            ...
            <p className="text-sm leading-relaxed mb-3" style={{ color: 'var(--text-secondary)' }}>
              If you only want to revoke Voxility&apos;s access to your Facebook or Instagram data without
              deleting your Voxility account, you can do this directly inside Facebook:
            </p>
            <ol className="text-sm leading-relaxed space-y-1 list-decimal pl-5" style={{ color: 'var(--text-secondary)' }}>
              ...
              <li>Find <strong>Voxility</strong> in the list of connected apps</li>
              <li>Click <strong>Remove</strong> &mdash; this revokes all tokens immediately</li>
            </ol>
            <p className="text-sm leading-relaxed mt-3" style={{ color: 'var(--text-secondary)' }}>
              When you revoke access this way, Voxility receives a deauthorization webhook from Meta and
