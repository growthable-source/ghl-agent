      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-zinc-700 bg-zinc-950 hover:bg-zinc-900 hover:border-zinc-600 transition-colors text-sm font-medium"
          >
