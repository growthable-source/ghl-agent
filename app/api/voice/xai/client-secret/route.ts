 ...
 *
 * Note: we used to also return a tool list for the realtime session,
 * but XAI realtime doesn't reliably support function-calling. The brain
 * lives server-side in /api/voice/agent-turn now; XAI's job is only
 * STT + TTS.
 */
