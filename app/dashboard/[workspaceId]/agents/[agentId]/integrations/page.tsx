...
export default function AgentIntegrationsPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      {/* Per-agent CRM connection — connections belong to the agent, not
          the workspace. Shared card with voice agents' configuration page. */}
      <AgentCrmCard
        workspaceId={workspaceId}
        agentId={agentId}
        returnTo={`/dashboard/${workspaceId}/agents/${agentId}/integrations`}
      />
