...
export default function TriggersPage() {
  ...
  useEffect(() => {
    fetch(`/api/locations/${locationId}/agents/${agentId}/triggers`)
      .then(r => r.json())
  ...
  async function toggleActive(t: AgentTrigger) {
    const res = await fetch(`/api/locations/${locationId}/agents/${agentId}/triggers/${t.id}`, {
      method: 'PATCH',
  ...
  async function deleteTrigger(id: string) {
    await fetch(`/api/locations/${locationId}/agents/${agentId}/triggers/${id}`, { method: 'DELETE' })
  ...
  async function createTrigger(e: React.FormEvent) {
    e.preventDefault()
    setCreating(true)
    const res = await fetch(`/api/locations/${locationId}/agents/${agentId}/triggers`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        eventType,
