...
export default async function DashboardPage() {
  ...
  // No workspaces — the onboarding modal (rendered in layout.tsx) handles
  // workspace creation for new users. For users who completed onboarding
  // but somehow have no workspaces, show the create button.
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">No workspaces yet</p>
            </div>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-12 text-center">
            ...
            <p className="text-zinc-500 text-sm mb-6 max-w-md mx-auto">
              A workspace is where your AI agents, CRM connections, and contacts live. You can create multiple workspaces for different businesses.
            </p>
            ...
            >
              ...
              <div className="flex items-center gap-6 text-right">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs">connections</p>
                </div>
