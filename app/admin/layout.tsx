    ...
    <div className="min-h-screen flex bg-zinc-950 text-zinc-100">
      <aside className="w-56 shrink-0 border-r border-zinc-800 bg-zinc-950 flex flex-col">
        ...
        <nav className="flex-1 p-2 space-y-0.5 text-sm">
          ...
          <NavLink href="/admin/help-center" label="Help Center" />
          <NavLink href="/admin/users" label="Users" />
          <NavLink href="/admin/conversations" label="Conversations" />
          <NavLink href="/admin/portals" label="Portals" />
          <NavLink href="/admin/simulations" label="Simulations" />
          <NavLink href="/admin/simulation-swarms" label="Swarms" />
          <NavLink href="/admin/learnings" label="Learnings" />
          <NavLink href="/admin/logs" label="Message logs" />
          <NavLink href="/admin/costs" label="LLM costs" />
