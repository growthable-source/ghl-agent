...
export const metadata = {
  title: 'Help Center — Xovera',
  description: 'Guides, videos and reference for the Xovera conversational AI platform.',
      ...
      <header className="sticky top-0 z-40 border-b border-zinc-800 bg-zinc-950/85 backdrop-blur">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link href="/help" className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-sm">Xovera Help</span>
          </Link>
