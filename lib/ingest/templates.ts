...
export const SOURCE_TYPE_CARDS: SourceTypeCard[] = [
  ...
  },
  {
    ...
    description: 'Index transcripts from a YouTube channel (latest 15 videos via RSS) or a single video. Works for any video with public captions.',
    icon: '🎥',
    available: true,
    identifierLabel: 'YouTube URL',
    identifierPlaceholder: 'https://youtube.com/@channel  or  https://youtu.be/abc123',
    identifierHint: 'Paste a channel URL (latest 15 videos) or a single-video URL. Playlist support is a follow-up.',
    defaultConfig: { recrawlIntervalDays: 7 },
  },
  {
    sourceType: 'rss',
    name: 'RSS / Atom Feed',
    description: 'Subscribe to a blog, release-notes feed, or any RSS/Atom URL. New posts get ingested on each crawl.',
    icon: '📰',
    available: true,
    identifierLabel: 'Feed URL',
    identifierPlaceholder: 'https://blog.example.com/rss',
    identifierHint: 'Most blogs expose /rss, /feed, or /atom.xml — paste it here.',
    defaultConfig: { recrawlIntervalDays: 1, maxItems: 100 },
  },
  {
    sourceType: 'notion',
