...
export const SOLUTIONS: Solution[] = [
  {
    ...
    metaTitle: 'AI Customer Service Software — Voxility',
    metaDescription:
      'AI customer service across chat, email, SMS, social, and voice. Voxility answers from your knowledge base, books and qualifies in your CRM, hands off to humans with a live queue, and improves every week.',
    ...
    intro:
      'Most “AI customer service” is a website chatbot that deflects FAQs and stops there. Voxility runs a real agent across chat, email, SMS, WhatsApp, Instagram, Facebook, Google Business, and voice — grounded in your own knowledge, able to book appointments, update contacts, and escalate to a human with a live queue. And it gets measurably better from every conversation it has.',
    features: [
    ...
    faqs: [
      ...
      { q: 'How is it different from a chatbot?', a: 'A chatbot answers. Voxility resolves — it books, qualifies, and updates your CRM, works voice and social, and improves automatically.' },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Build an AI chat widget that answers, qualifies, books, and hands off to a human with a live queue. Voxility’s embeddable widget supports voice, your branding, and native CRM actions. Free in beta.',
    ...
    intro:
      'Voxility’s chat widget is a full AI agent you embed with a single line of script. Customize the look to match your brand, let visitors talk or type, answer from your own knowledge, and hand off to a human with a live queue when needed — all wired into your CRM.',
    features: [
