...
export const ALTERNATIVES: Alternative[] = [
  {
    ...
    metaDescription:
      'Looking for an Intercom alternative? Xovera runs AI agents across chat, SMS, email, social, and voice — that book, qualify, and update your CRM natively, and get better every week. Free while in beta.',
    hook: 'Intercom is a great support inbox. Xovera is an AI agent that actually does the work — across every channel, plugged straight into your CRM, improving from every conversation.',
    theirPitch:
    ...
    faqs: [
      { q: 'Is Xovera a true Intercom alternative?', a: 'For sales and lead-gen teams, yes. Xovera covers live chat plus voice, SMS, and social, and the agent takes CRM actions natively. If you specifically need Intercom’s help center and in-app product tours, Intercom remains stronger there — Xovera focuses on agents that qualify, book, and update your CRM.' },
      { q: 'How is pricing different from Intercom / Fin?', a: 'Intercom blends per-seat pricing with per-resolution charges on Fin. Xovera is a flat plan (and free during beta), so cost doesn’t spike with conversation volume.' },
      { q: 'Can I keep my existing CRM?', a: 'Yes — Xovera installs from the GoHighLevel Marketplace and integrates with HubSpot. The agent reads and writes your CRM directly.' },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'A Fin alternative for teams who want more than support deflection: Xovera AI agents take calls, texts, and chats, book and qualify in your CRM, and improve automatically. No per-resolution fees.',
    hook: 'Fin is a strong support-deflection bot priced per resolution. Xovera is a full agent — voice + chat + CRM actions — on a flat plan that doesn’t tax you per conversation.',
    theirPitch:
    ...
    faqs: [
      { q: 'Does Xovera deflect support questions like Fin?', a: 'Yes — point it at your website, docs, and data sources and it answers grounded questions. It also goes further: booking, qualifying, and updating your CRM, plus voice and social channels.' },
      { q: 'How does pricing compare to Fin?', a: 'Fin charges per resolution. Xovera is a flat plan (free during beta), so cost is predictable regardless of conversation volume.' },
      { q: 'Can it run on the phone?', a: 'Yes. Xovera handles inbound and outbound voice calls with natural voices, which Fin does not.' },
    ],
    updatedAt: '2026-06-17',
  },
  {
    ...
    metaDescription:
      'A Zendesk AI alternative built for sales and marketing: Xovera AI agents work voice, chat, SMS, and social, take native CRM actions in GoHighLevel and HubSpot, and improve every week.',
    hook: 'Zendesk AI is built for enterprise support queues. Xovera is built to win and serve leads — across channels, inside your CRM, getting smarter automatically.',
    theirPitch:
    ...
    ourAngle:
      'Xovera isn’t a ticketing system — it’s an AI agent for sales-and-marketing motions. It qualifies and books, runs voice calls and social DMs, lives natively inside GoHighLevel/HubSpot, and auto-improves from real conversations rather than relying on a team of admins to tune flows.',
    rows: [
    ...
    faqs: [
      { q: 'Is Xovera a Zendesk replacement?', a: 'For sales/marketing AI agents, yes. For enterprise support ticketing with SLAs and complex routing, Zendesk is the heavier system — Xovera focuses on agents that qualify, book, and act in your CRM across channels.' },
  ...
  },
  {
    ...
    metaDescription:
      'A Tidio (Lyro) alternative for teams who want more than a chat widget: Xovera AI agents work every channel including voice, take native CRM actions, and get better automatically. Free in beta.',
    hook: 'Tidio’s Lyro is a solid website chatbot. Xovera goes further — voice, social, and native CRM actions, with an agent that auto-improves from real conversations.',
    theirPitch:
    ...
    ourAngle:
      'Xovera is a full multi-channel agent platform. Beyond website chat, it runs voice calls, SMS, and social DMs, takes 26+ native CRM actions in GoHighLevel/HubSpot, simulates against seven personas before launch, and auto-applies improvements from every conversation.',
    rows: [
    ...
    faqs: [
      { q: 'Why pick Xovera over Tidio/Lyro?', a: 'If you only need a website chatbot, Tidio is fine. Xovera adds voice, social channels, 26+ native CRM actions, pre-launch simulation, and automatic self-improvement — built for converting leads, not just answering site visitors.' },
      { q: 'Does Xovera have a chat widget too?', a: 'Yes — an embeddable widget with optional voice and human handoff with a live queue, plus all the other channels.' },
      { q: 'Is there a free option?', a: 'Xovera is free during beta.' },
    ],
    updatedAt: '2026-06-17',
  },
  {
    ...
    metaDescription:
      'A Drift (Salesloft) alternative: Xovera AI agents run conversational marketing across chat, voice, SMS, and social, qualify and book natively in your CRM, and improve from every conversation.',
    hook: 'Drift pioneered conversational marketing chat. Xovera brings it to every channel — including voice — with native CRM actions and agents that get sharper each week.',
    theirPitch:
    ...
    ourAngle:
      'Xovera runs the same qualify-and-book motion but across voice, SMS, and social as well as chat, with native GoHighLevel/HubSpot actions and a self-improvement loop. It’s a fit for SMBs and agencies who want conversational marketing without enterprise pricing or setup.',
    rows: [
    ...
    faqs: [
      { q: 'Is Xovera a Drift alternative for SMBs?', a: 'Yes. It runs the qualify-route-book conversational motion across chat, voice, SMS, and social, with native CRM actions and flat pricing — without Drift/Salesloft’s enterprise footprint.' },
